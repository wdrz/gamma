...
/* Nie było wymagania, aby ustawiać errno, więc w wersji docelowej nie będziemy tego sprawdzać. */
...
/* Testuje, czy nie ma problemów przy wypisywaniu planszy w grze z dużą liczbą graczy. */
